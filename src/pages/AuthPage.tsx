...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen h-screen overflow-auto flex items-start justify-center pt-[25vh] bg-gradient-to-br from-background via-background to-muted p-4">
      <motion.div
