  ...
  const columns: ColumnDef<any>[] = useMemo(
    () => [
      ...
      },
      {
        ...
        resizable: false,
        draggable: true,
        renderCell: (row: any) => <TruncatedTextCell value={row.jobTitle} maxLength={30} />,
      },
      {
        id: "skillMix",
        label: "Skill Mix",
        ...
        resizable: false,
        draggable: true,
        renderCell: (row: any) => <TruncatedTextCell value={row.skillMix} maxLength={30} />,
      },
      {
        id: "vacancyAge",
        label: "Vacancy Age",
      ...
      },
      {
        ...
        resizable: false,
        draggable: true,
        renderCell: (row: any) => <TruncatedTextCell value={row.employmentType} maxLength={30} />,
      },
    ],
    [],
  );
