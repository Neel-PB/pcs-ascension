    ...
    <div className="flex flex-col gap-4 min-h-0 max-h-full overflow-hidden">
      ...
      {isFetching ? (
        ...
        <div className="min-h-0 max-h-full flex flex-col">
          <EditableTable data={filteredData} columns={columns} getRowId={(row) => row.id} onRowClick={handleRowClick} storeNamespace="contractor-requisitions" className="min-h-0 max-h-full" />
        </div>
      )}
