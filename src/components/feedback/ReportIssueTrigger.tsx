  ...
  return (
    <>
      <Button
        ...
        variant="ghost"
        className="fixed right-0 bottom-[168px] h-12 w-6 rounded-l-xl rounded-r-none bg-primary hover:bg-primary/90 shadow-xl active:scale-95 transition-all duration-300 ease-out z-50 flex items-center justify-center text-primary-foreground"
