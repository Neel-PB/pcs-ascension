  ...
  return (
    <>
      <Button
        ...
        variant="ghost"
        className="fixed right-0 bottom-[116px] h-12 w-6 rounded-l-xl rounded-r-none bg-destructive hover:bg-destructive/90 shadow-xl active:scale-95 transition-all duration-300 ease-out z-50 flex items-center justify-center text-destructive-foreground"
