...
export const staffingSteps: Step[] = [
  ...
  },
  {
    ...
    title: '12M Average',
    content: demoContent('Rolling 12-month average monthly volume of patient encounters or units of service.', 'mini-chart'),
    placement: 'bottom',
    disableBeacon: true,
  },
  {
    ...
    content: demoContent('Average daily volume over the past 12 months.', 'mini-chart'),
    placement: 'bottom',
    disableBeacon: true,
  },
  {
    ...
    title: '3M Low',
    content: demoContent('Average daily volume during the 3 lowest-volume months. Used for minimum staffing.', 'mini-chart'),
    placement: 'bottom',
    disableBeacon: true,
  },
  {
    ...
    title: '3M High',
    content: demoContent('Average daily volume during the 3 highest-volume months. Used for peak staffing.', 'mini-chart'),
    placement: 'bottom',
    disableBeacon: true,
  },
  {
    ...
    title: 'Target Volume',
    content: demoContent('Expected daily volume used for staffing calculations. Green border means it is active.', 'mini-chart'),
    placement: 'bottom',
    disableBeacon: true,
  },
  {
    ...
    content: demoContent('Manually set volume that supersedes the target. Orange border means it is active.', 'mini-chart'),
    placement: 'bottom',
    disableBeacon: true,
  },
  {
