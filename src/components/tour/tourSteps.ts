...
export const staffingSteps: Step[] = [
  ...
  { target: '[data-tour="kpi-target-vol"]', title: 'Target Volume', content: demoContent('Expected daily volume used for staffing calculations. Green border means it is active.', 'target-vol-preview'), placement: 'bottom', disableBeacon: true, data: { wideTooltip: true } },
  { target: '[data-tour="kpi-override-vol"]', title: 'Override Volume', content: demoContent('Manually set volume that supersedes the target. Orange border means it is active.', 'override-vol-preview'), placement: 'bottom', disableBeacon: true, data: { wideTooltip: true } },
