...
const guideCatalog: Guide[] = [
  ...
  { tourKey: "positions-open-requisition", title: "Open Requisition", description: "Open requisitions with status tracking and pipeline visibility.", icon: Briefcase, route: "/positions?tab=open-requisition", category: "Positions" },
  { tourKey: "positions-requisitions", title: "Open Positions", description: "Open positions with vacancy age tracking and comments.", icon: Users, route: "/positions?tab=open-position", category: "Positions" },
  ...
  { tourKey: "positions-contractor-requisition", title: "Contractor Requisition", description: "Contractor requisitions with status tracking and pipeline visibility.", icon: Briefcase, route: "/positions?tab=contractor-requisition", category: "Positions" },
