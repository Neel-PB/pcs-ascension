...
const guideCatalog: Guide[] = [
  ...
  { tourKey: "positions-contractors", title: "Contractors", description: "Contractor roster with FTE and shift override controls.", icon: Briefcase, route: "/positions?tab=contractors", stepCount: 7, category: "Positions" },
  { tourKey: "positions-requisitions", title: "Open Positions", description: "Open requisitions with vacancy age tracking and comments.", icon: Users, route: "/positions?tab=requisitions", stepCount: 5, category: "Positions" },
  ...
  { tourKey: "admin-rbac", title: "RBAC", description: "Role-based access control matrix and permission management.", icon: Shield, route: "/admin?tab=access-control", stepCount: 4, category: "Admin" },
  { tourKey: "admin-audit", title: "Audit Log", description: "Track all role and permission changes with timestamps.", icon: History, route: "/admin?tab=audit-log", stepCount: 3, category: "Admin" },
  { tourKey: "admin-settings", title: "Admin Settings", description: "UI settings, volume configuration, and system controls.", icon: Settings, route: "/admin?tab=settings", stepCount: 3, category: "Admin" },
