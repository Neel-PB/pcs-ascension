...
export function AppHeader() {
  ...
  return (
    <header className="fixed top-0 right-0 z-40 flex items-center border-b border-l border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60" style={{ left: 'var(--sidebar-width)', height: 'var(--header-height)' }}>
