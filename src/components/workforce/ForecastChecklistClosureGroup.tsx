    ...
    <div className="border-b border-border/50 last:border-b-0">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium tabular-nums text-red-600">{skillGroup.totalFTE.toFixed(1)} FTE</span>
        </div>
      </button>
